<template>
  <div>
    <el-dialog title="编辑检查项" :visible.sync="parentDialog" :show-close="false" :close-on-click-modal="false" custom-class="medium-dialog">
  ...
  methods: {
    ...
    * */
    ...
    sendRequest () {
      ...
      this.$axios({
        method: 'post',
        url: this.sysetApi() + '/altStandardsCheckMes',
        data: params
      }).then((res) => {
        this.disabled = false
