...
// 引入新增组件
import addModule from '@/components/facility/envswg-add'
// 引入编辑组件
import comModule from '@/components/facility/envswg-com'
// 引入详情组件
import detModule from '@/components/facility/envswg-det'
// 引入删除组件
import delModule from '@/components/facility/envswg-del'
export default{
  name: 'envswg',
  data () {
    return {
