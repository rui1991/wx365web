...
// 引入新增组件
import addModule from '@/components/location/vehicle-fence-add'
// 引入编辑组件
import detModule from '@/components/location/vehicle-fence-det'
// 引入编辑组件
import comModule from '@/components/location/vehicle-fence-com'
// 引入删除组件
